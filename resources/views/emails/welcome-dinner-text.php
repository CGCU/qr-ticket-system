...
Dear <?php echo $purchaser->first_name . " " . $purchaser->last_name; ?>,
This is your ticket for the CGCU Welcome Dinner.

Please have this ready when you're entering the venue.

If the ticket is on your phone, please turn your brightness up and zoom into the QR Code attached.
Ticket number: <?php echo $qr; ?>
